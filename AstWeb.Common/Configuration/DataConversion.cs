...
{
    /// <summary>
    /// 数据转换类  Xuwx Add 20170208
    /// </summary>
    public class DataConversion
    { 
        /// <summary>
        /// string 数组 转 int By Xuwx Add 20170209
        /// </summary>
        ...
        public static DateTime? StrToDateTime(object strValue, DateTime? defValue)
        {
            ...
            if (!DateTime.TryParse(strValue.ToString(), out tempVal))
            {
                val = defValue;
            }
            else
        ...
        {
            return IntToDateTime(DataConversion.StrToInt(input, 0));
        }
        ...
        {
            return StrIntToDateTime(DataConversion.StrToInt(input, 0)).ToString("yyyy-MM-dd HH:mm:ss");
        }
        ...
        /// <summary>
        /// NPOI转换Excel日期时间格式,出错时直接抛出异常
        /// </summary>
        /// <param name="_datetime"></param>
        /// <returns></returns>
        public static string NPOIParseDateTimeException(string _datetime)
        {
        ...
        private static string NPOIParseDate(string _date)
        {
           ...
           "MMddyy", "MMddyyyy",  "yyyyMMdd","yyMMdd", 
